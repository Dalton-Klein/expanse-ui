...
export default function CameraControls({
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      switch (event.code) {
        ...
        case "KeyQ": keysRef.current.down = true; break;
        case "KeyE": keysRef.current.up = true; break;
    ...
    const handleKeyUp = (event: KeyboardEvent) => {
      switch (event.code) {
        ...
        case "KeyQ": keysRef.current.down = false; break;
        case "KeyE": keysRef.current.up = false; break;
  ...
  useFrame((state, delta) => {
    ...
    const speed = movementSpeed * (keysRef.current.shift ? 2 : 1);
    ...
    velocity.addScaledVector(camera.up, direction.y * speed);
