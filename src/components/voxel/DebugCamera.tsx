...
export default function DebugCamera() {
  ...
  useFrame((_, delta) => {
    ...
    const currentSpeed = keys.current.shift ? moveSpeed * 3 : moveSpeed;
    ...
    velocity.current.addScaledVector(forward, -direction.current.z * currentSpeed * delta);
    velocity.current.addScaledVector(right, direction.current.x * currentSpeed * delta);
    velocity.current.addScaledVector(up, direction.current.y * currentSpeed * delta);
